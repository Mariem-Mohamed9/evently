import 'package:evently/event_datails_screen.dart';
...
class _HomeTabState extends State<HomeTab> {
        ...
        Expanded(
          child: ListView.separated(
              ...
              itemBuilder: (_,index)  {
                ...
                return InkWell(
                  onTap: () async{
                    final result=  await Navigator.of(context).pushNamed(EventDetailsScreen.routeName , arguments: event);
                    if(result==true){
                      await  getEvents();
  ...
  void filterEvents(CategoryModel? Category){
    ...
    if(Category==null){
      ...
      displayEvents = allEvents.where((event) =>event.category==Category).toList();
    }
    setState(() { });
  }
}