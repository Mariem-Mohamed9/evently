          ...
          children: [
            Padding(
              ...
              child: ClipRRect(
                  ...
                  child: Image.asset("assets/images/${selectedCategory.imageName}.png" , height: MediaQuery.sizeOf(context).height*0.23, width: double.infinity,fit: BoxFit.fill,)
              ),
            ),
                    ...
                    Row(
                      children: [
                        ...
                        InkWell(
                            ...
                            child: Text( selectedTime==null? "Choose Time": selectedTime!.format(context) , style: textTheme.titleMedium!.copyWith(color: AppTheme.primary)))
                      ],
                    ),
