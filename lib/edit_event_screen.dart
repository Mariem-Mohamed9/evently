          ...
          children: [
            Padding(
              ...
              child: ClipRRect(
                  ...
                  child: Image.asset( selectedCategory==null? "assets/images/${widget.event.category.imageName}.png" :"assets/images/${selectedCategory!.imageName}.png" ,
                    height: MediaQuery.sizeOf(context).height*0.23, width: double.infinity,fit: BoxFit.fill,)
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  DefaultTextFormField(
                    ...
                    prefixIconImageName: "Note_Edit", hintText: '' ,
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Text(selectedDate==null?formattedDate:  dateFormat.format(selectedDate!) , style:  textTheme.titleMedium!.copyWith(color: AppTheme.primary),),
                      )
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      ...
                      InkWell(
                        ...
                        child: Text(selectedTime==null?formattedTime:selectedTime!.format(context) ,
                          style:  textTheme.titleMedium!.copyWith(color: AppTheme.primary),),
                      )
                    ],
                  ),
                  SizedBox(height: 24),
                  DefaultElevatedButton(label: "Update Event", onPressed:updateEvent )
