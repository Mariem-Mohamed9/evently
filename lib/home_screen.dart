...
import 'package:evently/tabs/profil/profil_tab.dart';
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: BottomNavigationBar(
          ...
          currentIndex: currentIndex,
            ...
            items:[
          BottomNavigationBarItem(icon:NavBarIcon(imageName: 'home')  ,
          ...
          BottomNavigationBarItem(icon:NavBarIcon(imageName: 'heart')  ,
              activeIcon: NavBarIcon(imageName: 'heart_active')  ,
              label:'Love'
          ),
          BottomNavigationBarItem(icon:NavBarIcon(imageName: 'profil')  ,
              activeIcon: NavBarIcon(imageName: 'profil_active')  ,
              label:'Profil'
          ),
        ]),
      ),
